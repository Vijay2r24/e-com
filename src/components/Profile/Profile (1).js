...
import { LocationDataContext } from "../../components/Context/DataContext";
...
const Profile = () => {
  ...
  const { storesData } = useContext(LocationDataContext);
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      Object.keys(formData).forEach((key) => {
        if (key === "profileImageUrl" && formData[key]) {
      ...
      const apiUrl = userCreateOrUpdate; // API URL
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        ...
        setLogindata((prevData) => ({
          ...prevData,
          profileImageUrl: reader.result, // Base64 URL for preview
        }));

        setFormData((prevFormData) => ({
          ...prevFormData,
          profileImageUrl: file, // File for backend submission
        }));
      };
                  ...
                  {isEditing && (
                    ...
                    >
                      ...
                      <input
                        ...
                        accept="image/*"
                        className="hidden"
                        onChange={handleImageChange} // Handles image upload
                      />
                    </button>
                  )}
            ...
            <div className="user-details">
              {!isEditing && (
                <div>
                  ...
                  <div className="bg-white rounded-lg w-full h-auto border border-gray-200">
                    <div className="flex flex-wrap justify-end gap-4 mt-4 mr-6">
                      <button
                        onClick={handleUpdateButtonClick}
                        className="inline-flex justify-center rounded-md border border-transparent bg-pacific-500 py-2 px-4 text-sm font-medium text-white hover:text-black shadow-sm hover:bg-pacific-600 focus:outline-none"
                      >
                        Update
                      </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2 pb-4 px-4 md:px-20 mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2 pb-4 px-4 md:px-20">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-800 mr-4 md:mr-8">:</span>
                        <p className="text-sm font-medium text-gray-700">{logindata.StoreName}</p>
                      </div>
                      <div className="flex items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2 pb-4 px-4 md:px-20">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-800 mr-4 md:mr-8">:</span>
                        <p className="text-sm font-medium text-gray-700">{logindata.Email}</p>
                      </div>
                      <div className="flex items-center">
                        <p className="text-sm font-semibold text-gray-500 w-1/3">Phone Number</p>
                        <span className="text-gray-800 mr-4 md:mr-8">:</span>
                        <p className="text-sm font-medium text-gray-700">{logindata?.PhoneNumber}</p>
                      </div>
                    </div>
                    ...
                    {/* Location Section */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2 px-4 md:px-20">
                      <div className="flex items-center">
                        <p className="text-sm font-semibold text-gray-500 w-1/3">Country</p>
                        <span className="text-gray-800 mr-4 md:mr-8">:</span>
                        <p className="text-sm font-medium text-gray-700">{logindata.CountryName}</p>
                      </div>
                      <div className="flex items-center mb-4">
                        <p className="text-sm font-semibold text-gray-500 w-1/3">State</p>
                        <span className="text-gray-800 mr-4 md:mr-8">:</span>
                        <p className="text-sm font-medium text-gray-700">{logindata?.StateName}</p>
                      </div>
                    </div>
                  </div>
                        ...
                        >
                          <div className="relative">
                            <Combobox.Input
                              id="State"
                              name="State"
                              className={`block w-full rounded-md border  py-2 px-4 shadow-sm  sm:text-sm mt-2 mb-1 ${!formData.StateID && errors.StateIdError
                                ? "border-red-400"
                                : "border-gray-400"
                                }`}
                        ...
                        >
                          <div className="relative">
                            <Combobox.Input
                              id="City"
                              name="City"
                              className={`block w-full rounded-md border  py-2 px-4 shadow-sm  sm:text-sm mt-2 mb-1 ${!formData.CityID && errors.CityIdError
                                ? "border-red-400"
                                : "border-gray-400"
                                }`}
                              onChange={(event) => setQuery(event.target.value)} // Handle the search query
